...
func (c *greeterClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/calculadora.Greeter/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Sub(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/calculadora.Greeter/Sub", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Div(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/calculadora.Greeter/Div", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) Mul(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/calculadora.Greeter/Mul", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculadora.Greeter/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Add(ctx, req.(*Request))
	}
...
func _Greeter_Sub_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculadora.Greeter/Sub",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Sub(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_Div_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculadora.Greeter/Div",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Div(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_Mul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculadora.Greeter/Mul",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Mul(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "calculadora.Greeter",
...
var fileDescriptor_3e936b298201aba0 = []byte{
	...
	0xac, 0x8f, 0x35, 0x88, 0xd1, 0xcf, 0xe8, 0x2a, 0x23, 0x17, 0xbb, 0x7b, 0x51, 0x6a, 0x6a, 0x49,
	0x6a, 0x91, 0x90, 0x21, 0x17, 0xb3, 0x63, 0x4a, 0x8a, 0x90, 0x88, 0x1e, 0xb2, 0x2b, 0xa0, 0xf6,
	0x49, 0x09, 0xa1, 0x89, 0x16, 0xe4, 0x54, 0x2a, 0x31, 0x80, 0xb4, 0x04, 0x97, 0x26, 0x91, 0xaa,
	0xc5, 0x25, 0xb3, 0x8c, 0x54, 0x2d, 0xbe, 0xa5, 0x39, 0xa4, 0x68, 0x49, 0x62, 0x03, 0x87, 0x9e,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xfc, 0x42, 0x79, 0x1f, 0x52, 0x01, 0x00, 0x00,
}
